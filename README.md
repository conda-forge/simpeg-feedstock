...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/simpeg-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7544&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/simpeg-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `simpeg` can be installed with:

```
conda install simpeg
```

It is possible to list all of the versions of `simpeg` available on your platform with:
